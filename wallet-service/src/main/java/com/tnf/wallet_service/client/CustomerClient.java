...
Used before creating a wallet to verify that the owning customer actually exists, 
since there is no cross-service foreign key between walletdb and customerdb.
